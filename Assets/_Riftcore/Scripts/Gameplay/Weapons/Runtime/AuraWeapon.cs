...
{
    public sealed class AuraWeapon : Weapon<WeaponData>
    {
        private readonly List<Enemy> _enemies = new();
        
        public AuraWeapon(WeaponData weaponData, Player player, EnemyGrid enemyGrid) : base(weaponData, player, enemyGrid) { }
